...
- 樣本期指數 22k→40k 是罕見大多頭，而 B3 的 200MA 閘門讓它**結構性做多**；
  它賺到的可能主要是 beta，不是選擇權的 edge。空頭或長期橫盤樣本尚未檢驗
...
3. B3 的空頭壓力測試（切 2022 熊市段回測）——需先 backfill 更早資料，
   這是**額外檢驗、不是翻案機會**：結果不影響已記錄的 PASS
